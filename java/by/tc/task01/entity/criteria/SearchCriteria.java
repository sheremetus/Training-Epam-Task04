...
public final class SearchCriteria {
    ...
    public static List<String> getParameterNamesOfTheAllAppliances() {
        List<String> allNamesOfTheParameters = new ArrayList<>();
        for (Class<?> searchCriteria : SearchCriteria.class.getClasses()) {

            for (Object parameter : searchCriteria.getEnumConstants()) {
            allNamesOfTheParameters.add(parameter.toString());
            }
        }
    return allNamesOfTheParameters;
    }
}
